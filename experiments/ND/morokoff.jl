...
CSV.write("experiments/ND/results/bmc_exp2_means.csv", mean_df)
CSV.write("experiments/ND/results/bmc_exp2_stds.csv", std_df)
CSV.write("experiments/ND/results/bmc_exp2_err_means.csv", err_df)
CSV.write("experiments/ND/results/bmc_exp2_err_stds.csv", err_σ_df)
CSV.write("experiments/ND/results/bmc_exp2_data.csv", DataFrame(data, ["x1", "x2", "x3", "x4", "x5", "y", "y_noisy"]))
